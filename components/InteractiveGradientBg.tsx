...
export default function InteractiveGradientBg() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      g1.addColorStop(0, "rgba(206, 168, 92, 0.30)");
      g1.addColorStop(0.35, "rgba(222, 196, 132, 0.16)");
      g1.addColorStop(0.7, "rgba(242, 232, 210, 0.06)");
      ...
      g2.addColorStop(0, "rgba(184, 138, 70, 0.20)");
      g2.addColorStop(0.4, "rgba(208, 172, 108, 0.10)");
      g2.addColorStop(0.8, "rgba(238, 226, 204, 0.04)");
      g2.addColorStop(1, "rgba(246, 241, 232, 0)");
      ctx.fillStyle = g2;
      ctx.fillRect(0, 0, w, h);

      // Orb 3 — faint pitch-green sporting accent at bottom, drifts gently
      const bx = w * 0.4 + (0.5 - eased.x) * w * 0.5;
      const by = h * 0.82 + (0.5 - eased.y) * h * 0.15;
      const g3 = ctx.createRadialGradient(bx, by, 0, bx, by, w * 0.5);
      g3.addColorStop(0, "rgba(60, 120, 88, 0.12)");
      g3.addColorStop(0.5, "rgba(120, 165, 138, 0.05)");
